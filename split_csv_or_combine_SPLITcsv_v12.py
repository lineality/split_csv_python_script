...
def main_split_csv_iterator(combine = False):
    ...
    while file_ok is False:
        ...
        try:
            user_input = input("Divide .csv into how many pieces? (even number) OR say 'combine' to recombine. \n ")
            ...
            if user_input == "combine":
                ...
                number_of_final_files = int( user_input )
            ...
            file_ok is False
            print("That did not work. Please try an even integer (like 2, 4, 6, etc.) or 'combine' \n")
